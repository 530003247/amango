...
smjq(document).ready(function(){
        ...
        //Amango 关闭显示  菜单设置
		smjq("body").append('<div id="smchuncai" onfocus="this.blur();" style="color:#626262;z-index:999;">'+
			                '<div id="chuncaiface"></div>'+
			                '<div id="dialog_chat"><div id="chat_top"></div>'+
			                '<div id="dialog_chat_contents"><div id="dialog_chat_loading"></div><div id="tempsaying"></div>'+
			                '<div id="showchuncaimenu">'+
		'<ul class="wcc_mlist" id="shownotice">健康体检</ul>'+
		'<ul class="wcc_mlist" id="chatTochuncai">客服答疑</ul>'+
		'<ul class="wcc_mlist" id="foods">文章管理</ul>'+
		'<ul class="wcc_mlist" id="blogmanage">关 键 词</ul>'+
		'<ul class="wcc_mlist" id="lifetimechuncai">日志记录</ul>'+
		'<ul class="wcc_mlist" id="closechuncai">关闭芒果</ul></div>'+
		'<div>'+
		'<ul id="chuncaisaying"></ul>'+
		'</div>'+
		'<div id="getmenu"> </div>'+
		'</div><div id="chat_bottom"></div>'+
		'</div></div>');
		...
		smjq("body").append('<div id="callchuncai" style="width: 100px;">召唤小芒果</div>');
		//判断春菜是否处于隐藏状态
...
var talktime = 0;
//设置自言自语频率（单位：秒）
//Amango  自言自语设置(公众号客服系统)
var talkself = 60;
var talkobj;
var tsi = 0;
var talkself_arr = [
	["<a href='hao123.com'>白日依山尽，黄河入海流，欲穷千里目，更上.....一层楼？</a>", "1"],
	["我看见主人熊猫眼又加重了！", "3"],
	["我是不是很厉害呀～～？", "2"],
