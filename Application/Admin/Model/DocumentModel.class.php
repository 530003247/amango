...
class DocumentModel extends Model{
    ...
    protected $_auto = array(
        ...
        //芒果新增
        array('replyunique', 'getReplyunique', self::MODEL_BOTH, 'callback'),
        array('replylimit', 'getReplylimit', self::MODEL_BOTH, 'callback'),
        array('denyuser', 'getDenyuser', self::MODEL_BOTH, 'callback'),
    ...
    public function getReplyunique(){
        $replyunique = I('post.replyunique');
        return empty($replyunique)? 1:$replyunique;
    }
    ...
    public function getReplylimit(){
        $replylimit = I('post.replylimit');
        return is_numeric($replylimit)? $replylimit:0;
    }
    /**
     * 获取文档列表
